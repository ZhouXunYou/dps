...
//import com.vividsolutions.jts.geo.geojson.geom.GeometryJSON
...
//    
//      val dataset = this.jdbcQuery(params, "(select id,name,region,area from t_security_area) as tmpView", sparkSession)
//      dataset.repartition(4).write.mode(SaveMode.Append).partitionBy("name").parquet("D:/test/parquet")
//      
//  }
//
//  /**
